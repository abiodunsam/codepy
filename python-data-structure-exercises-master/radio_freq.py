...
parser.add_argument("station", help="pass in station", nargs="?")
...
for key, value in fm_frequencies.items():
    if value == args.station:
        prnt =  "You can listen to {} on {}".format(value, key)
        foundmatch = True
        print(prnt)


if foundmatch==False and foundargs==True:
    print('list of all stations that the program does know about')
    print(list(fm_frequencies.values()))


if foundargs==False:
    print(list(fm_frequencies.items()))
